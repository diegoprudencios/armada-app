...
import { EARN_PROCESSING_STAGES, earnFinalStageLabel, type EarnTab } from '@/pages/earnFlowConstants'
import styles from './EarnProcessingStepper.module.css'

const DEMO_RECORD_ID = '01JKEARN9MVT3SZ6XQ0ZI9XVFAP'
...
export function EarnProcessingStepper({
  ...
  const stages = [
    ...EARN_PROCESSING_STAGES,
    { id: 'hub-confirmed', label: earnFinalStageLabel(tab) },
  ]
        ...
        <section className={styles.detailsCard} aria-label="Technical details">
          <TechnicalDetailsDisclosure className={styles.detailsDisclosure}>
            <dl className={styles.facts}>
              ...
              <div>
                <dt>Kind</dt>
                <dd>{tab === 'add' ? 'yield-deposit' : 'yield-withdraw'}</dd>
              </div>
              <div>
                <dt>Stage</dt>
